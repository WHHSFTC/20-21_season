...
object SummumConstants {
    ...
    @JvmField var GEAR_RATIO = 22.0/18.0 // output (wheel) speed / input (motor) speed
    ...
    val SLOW_CONSTRAINTS = BASE_CONSTRAINTS.copy().apply { maxVel = 10.0 }
