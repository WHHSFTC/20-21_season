...
class Time private constructor(val nanoseconds: Long) {
    val milliseconds get() = nanoseconds / NANO_IN_MILLI
    val seconds get() = nanoseconds / NANO_IN_SECOND
    ...
    companion object {
        const val NANO_IN_MILLI = 1_000_000
        ...
        fun milli(ms: Long) = Time(ms * NANO_IN_MILLI)
        fun seconds(s: Long) = Time(s * NANO_IN_SECOND)
    }
}
